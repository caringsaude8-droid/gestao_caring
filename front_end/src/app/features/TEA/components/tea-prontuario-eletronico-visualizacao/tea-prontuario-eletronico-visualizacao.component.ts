...
@Component({
  selector: 'app-tea-prontuario-eletronico-visualizacao',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './tea-prontuario-eletronico-visualizacao.component.html',
  styleUrls: ['../tea-prontuario-eletronico/tea-prontuario-eletronico.component.css']
})
export class TeaProntuarioEletronicoVisualizacaoComponent implements OnInit {
  pageTitle = 'Prontuário Eletrônico (Visualização)';
  ...
  ngOnInit(): void {
    ...
    if (mock) {
      this.paciente = mock;
      this.pageTitle = `Prontuário Eletrônico (Visualização) — ${mock.nome}`;
    }
  }
