...
export class TeaCalendarioPorPacienteComponent implements OnInit {
  ...
  baseSchedule: Array<{ dayOffset: number; time: string; patient: string; professional: string; therapy: string }> = [
    { dayOffset: 0, time: '14:00', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Geo Psi', therapy: 'Terapia ABA' },
    { dayOffset: 1, time: '14:00', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Marcos Antônio', therapy: 'Terapia ABA' },
    { dayOffset: 2, time: '14:00', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Marcos Antônio', therapy: 'Terapia ABA' },
    { dayOffset: 3, time: '14:00', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Ana Carolina', therapy: 'Terapia ABA' },
    { dayOffset: 4, time: '14:00', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Ana Carolina', therapy: 'Terapia ABA' },

    { dayOffset: 1, time: '14:50', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Marcos Antônio', therapy: 'Terapia ABA' },
    { dayOffset: 2, time: '14:50', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Isaura', therapy: 'Nutricionista' },
    { dayOffset: 3, time: '14:50', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Wylly', therapy: 'Psicomotricidade Funcional' },
    { dayOffset: 4, time: '14:50', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Aldair Ivo', therapy: 'Psicopedagogo' },

    { dayOffset: 1, time: '15:40', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Ana', therapy: 'Fonoaudiólogo' },
    { dayOffset: 2, time: '15:40', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Lidja', therapy: 'Psicólogo' },
    { dayOffset: 3, time: '15:40', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Aldair Ivo', therapy: 'Psicopedagogo' },
    { dayOffset: 4, time: '15:40', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Geo Psi', therapy: 'Terapia ABA' },

    { dayOffset: 1, time: '16:30', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Elayne', therapy: 'Terapeuta Ocupacional' },
    { dayOffset: 2, time: '16:30', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Geo Psi', therapy: 'Terapia ABA' },
    { dayOffset: 3, time: '16:30', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Ana Carolina', therapy: 'Terapia ABA' },
    { dayOffset: 4, time: '16:30', patient: 'Diogo Thallys Alexandre de Abdias Silva', professional: 'Lidja', therapy: 'Psicólogo' },
  ];
  ...
  getCellContent(day: Date, time: string): { professional: string; therapy: string } | null {
    ...
    if (term && !(found.professional.toLowerCase().includes(term) || found.therapy.toLowerCase().includes(term))) {
      return null;
    }
    return { professional: found.professional, therapy: found.therapy };
  }
